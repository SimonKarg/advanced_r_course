...
The {lubridate}{.blue_highlight} package provides super easy ways to detect and convert date variables into any format imaginable. If you are working with data that has date/time information, you should work with lubridate.
